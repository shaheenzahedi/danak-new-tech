package org.danak.backend.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.danak.backend.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.danak.backend.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
