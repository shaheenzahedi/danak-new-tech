...
import org.danak.backend.DanakBackendApp;
import org.danak.backend.config.AsyncSyncConfiguration;
import org.danak.backend.config.EmbeddedMongo;
...
@SpringBootTest(classes = { DanakBackendApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
