...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './centre.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENTRE actions', async () => {
      const expectedActions = [
        {
