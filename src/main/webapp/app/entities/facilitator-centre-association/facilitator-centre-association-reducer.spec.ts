...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './facilitator-centre-association.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACILITATORCENTREASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACILITATORCENTREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACILITATORCENTREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACILITATORCENTREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACILITATORCENTREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACILITATORCENTREASSOCIATION actions', async () => {
      const expectedActions = [
        {
