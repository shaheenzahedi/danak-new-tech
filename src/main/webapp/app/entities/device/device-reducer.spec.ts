...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './device.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVICE actions', async () => {
      const expectedActions = [
        {
