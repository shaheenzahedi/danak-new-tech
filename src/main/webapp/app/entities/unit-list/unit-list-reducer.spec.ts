...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './unit-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNITLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNITLIST actions', async () => {
      const expectedActions = [
        {
