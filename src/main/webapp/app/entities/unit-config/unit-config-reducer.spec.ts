...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITCONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNITCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNITCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNITCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNITCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNITCONFIG actions', async () => {
      const expectedActions = [
        {
