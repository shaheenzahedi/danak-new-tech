...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './progress.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRESS actions', async () => {
      const expectedActions = [
        {
