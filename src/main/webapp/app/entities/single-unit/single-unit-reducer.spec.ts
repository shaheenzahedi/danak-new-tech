...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLEUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SINGLEUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLEUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLEUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLEUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLEUNIT actions', async () => {
      const expectedActions = [
        {
