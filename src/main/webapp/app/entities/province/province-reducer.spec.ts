...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './province.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVINCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVINCE actions', async () => {
      const expectedActions = [
        {
