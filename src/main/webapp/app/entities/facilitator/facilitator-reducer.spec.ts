...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACILITATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACILITATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACILITATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACILITATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACILITATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACILITATOR actions', async () => {
      const expectedActions = [
        {
