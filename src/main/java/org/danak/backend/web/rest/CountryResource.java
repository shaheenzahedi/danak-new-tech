...
/**
 * REST controller for managing {@link org.danak.backend.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public Mono<List<CountryDTO>> getAllCountries() {
    ...
    public Flux<CountryDTO> getAllCountriesAsStream() {
    ...
    public Mono<ResponseEntity<CountryDTO>> getCountry(@PathVariable String id) {
